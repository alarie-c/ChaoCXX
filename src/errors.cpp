...
Reporter::Reporter(std::string file_name, std::string path) : file_name(file_name), path(path) {}
void Reporter::push_error(const Error e) { this->errors.push_back(e); }

Error::Error(Type t, size_t y, size_t x0, size_t x1, Flag flag, std::string message)
